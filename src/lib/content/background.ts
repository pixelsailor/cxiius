	...
	instructorRoles: [
		{
			...
			startDate: '2011',
			endDate: '2013',
			summary: 'Led warm-up activities for youth after-school programs and adult classes. Worked one-on-one with students during group training to correct form and technique.'
		},
		{
