...
const data: DesignPortfolioEntry[] = [
	{
		...
		images: {
			thumbnail: { src: '/images/chateaucinq_logo-thumb.webp', alt: 'A stylized illustration of grapes on the vine over a leaf with the text "Le Chateau Cinq" in a stylized font.' },
		...
		description: 'Logo construction, paired type, and a restrained palette built for print and web alike. Created for a fictional wine estate as part of a project for Sessions.edu.'
	},
	{
		slug: 'cubs-website',
	...
	},
	{
		...
		images: {
			thumbnail: { src: '/images/gp_city-thumb.webp', alt: 'A stylized isometric illustration of a city showing SD cards in use at different locations and with different devices.' },
	...
	},
	{
		...
		projectType: 'ui',
		images: {
			thumbnail: { src: '/images/gemini_episodes-thumb.webp', alt: 'A screenshot of the Greenplay player UI showing a list of episodes for the show "It\'s Always Sunny in Philadelphia."' },
			full: { src: '/images/gemini_livingroom-933.webp', alt: 'A modern living room with Swedish style wood furniture and a large TV with the Greenplayer movie ribbon on the screen.' },
			hero: { src: '/images/gemini_livingroom-hero.webp', alt: 'A modern living room with Swedish style wood furniture and a large TV with the Greenplayer movie ribbon on the screen.' },
			showcase: [
				...
				{ src: '/images/gemini_moviedetail-933.webp', alt: 'A screenshot of the Greenplay player UI showing the detail screen for the movie "Gamer," with the movie title, description, and rating.' }
			],
		},
		featuredAsHero: true,
		circa: '2007',
		...
		description: 'The Greenplayer was a streaming media player that was used in the Greenplay ecosystem. Developed by MOD Systems in a time when Netflix only mailed physical DVDs, the Greenplayer was an attempt to bring movie rentals purchased from brick and mortar retailers into the digital age.',
	},
	// {
	...
	// },
	{
		...
		projectType: 'ui',
		images: {
			thumbnail: { src: '/images/bedrock_showcase-thumb.webp', alt: 'A photo of a small black car with the ocean in the background during sunset. The text, "The slide header" is superimposed on the image.' },
			full: { src: '/images/bedrock_showcase-933.webp', alt: 'A screenshot of the "Showcase" template from the Bedrock WordPress theme showing a photo of a small black car with the ocean in the background during sunset and an descriptive excerpt of the article underneath. A list of popular posts is shown in an aside column on the right.' },
			showcase: [
				{ src: '/images/bedrock_posts-933.webp', alt: 'A screenshot of the "Archive" template from the Bedrock WordPress theme showing a list of posts with their titles and excerpts.' },
			]
		},
		circa: '2012',
	...
	// },
	{
		...
		projectType: 'ui',
		images: {
			thumbnail: { src: '/images/mms_campaignart-thumb.webp', alt: 'A screenshot of the Media Management System demonstrating selecting artwork for an in-store marketing campaign.' },
		...
		description: 'The MOD Media Management System was a conceptual, web-based application for managing media content for in-store marketing campaigns. It was designed to complement a client\'s physical media kiosk system in stores as well as integrate with overhead digital signage systems. Client\'s could manage campaigns not only for single stores, but customizable regions or even the entire country. The MMS enabled in-store marketing campaigns to be managed from a central location, allowing for real-time updates and adjustments throughout all stores and included powerful options for managing artwork, playlists, and other media content. Workflows were deliberately designed to be easy to understand and use for everyone from the average sales associate to campaign managers and executives.',
	},
	{
		...
		images: {
			...
			showcase: [
				{ src: '/images/modcom_merch-933.webp', alt: 'A screenshot of the MOD Systems website "merchandise" page describing the company\'s kiosk and media server with photos of each.' },
	...
	},
	{
		...
		projectType: 'ui',
		images: {
			thumbnail: { src: '/images/fvm_av-thumb.webp', alt: 'A screenshot of the Frontline Vulnerability Manager Active View screen showing various graphs and charts displaying vulnerability data.' },
			...
			hero: { src: '/images/fvm_av-hero.webp', alt: 'A screenshot of the Frontline Vulnerability Manager Active View screen showing various graphs and charts displaying vulnerability data.' },
			showcase: [
	...
	},
	{
		...
		images: {
			...
			showcase: [
				{ src: '/images/nf_oldlogo-933.webp', alt: 'The original Norge Familie logo -- an intentionally crude depiction of a viking ship with rough lines.' },
			]
		},
		circa: '2024',
		technologies: ['Identity', 'Typography', 'Color systems', 'Logo design', 'Branding', 'Adobe Illustrator'],
		summary: 'Logo design for Norge Familie.',
		description: 'Logo design for Norge Familie. The original logo was intentionally crude and designed to be a simple, bold representation of the company\'s Viking heritage. The new logo is a more refined, modern design that is more consistent with the company\'s brand identity.',
	},
	{
		...
		projectType: 'branding',
		images: {
			thumbnail: { src: '/images/psdd_logo-thumb.webp', alt: 'The Profession Self Defense of Durango logo -- a mountain peak with a traditional Japanese Torii, or gate, in the center and Japanese characters on either side. The text "Profession Self Defense of Durango" surrounds the graphic in a circle.' },
			full: { src: '/images/psdd_logo-933.webp', alt: 'The Profession Self Defense of Durango logo -- a mountain peak with a traditional Japanese Torii, or gate, in the center and Japanese characters on either side. The text "Profession Self Defense of Durango" surrounds the graphic in a circle.' },
		},
		circa: '2003',
		technologies: ['Identity', 'Typography', 'Color systems', 'Logo design', 'Branding', 'Adobe Illustrator'],
