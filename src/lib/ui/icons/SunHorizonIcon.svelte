...
<IconRoot {size} {ariaLabel}>
  {#snippet children(iconSize: number | IconSize)}
    <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" viewBox="0 0 256 256" aria-label={ariaLabel || 'Sun and horizon icon'}>
      <path
