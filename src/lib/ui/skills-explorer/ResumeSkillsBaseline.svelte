<script lang="ts">
  ...
  import type { SkillCategoryMeta, SkillCategoryId, SkillRecord, SkillStackId, Proficiency } from '$lib/content/skills';
  ...
  const proficiencyName = (proficiencyKey: Proficiency): string => getProficiencyLevel(proficiencyKey).name;
</script>
