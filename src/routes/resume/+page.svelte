...
<div class="container">
	...
	<section class="summary-section will-fade">
		<p class="title-large summary">
			...
			accessibility, consistency, and usability by design while enabling AI-assisted development workflows. Proven leader in aligning cross-functional teams to deliver performant,
